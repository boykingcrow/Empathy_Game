...
{set("goo", "1")}
{get("goo") == "1":your mother sucks cocks in hell}
...
=look
    ...
    You look around the pool. You find nothing interesting. No movement. Nothing around but rocks and the occasional mushroom.->pool
...
{hands < 2:+ Hand removed from body.}
