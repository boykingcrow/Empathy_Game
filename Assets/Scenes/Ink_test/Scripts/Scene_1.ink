...
=outside_ship
    ...
    {shoot == 1:That's right! The motto of any good space adventurer: SHOOT FIRST! You shoot wildly at the creature, filling its terrifying form full of holes — well, at least that is what you intend to do. In reality,}
    
    {wait == 1: You wait. [REDACTED] CORP. issued plasma rifle pointed at... this unknownable Thing. Just being strange doesn't deserve a death sen tence after all. Such senseless murder probably, definitely even, would make you a complete. unforgivable. monster.}
    
 {wait == 1: Soon the shaking of your hands accedentally moves the gun from its "NOT MURDER" setting to "MURDER". However,}
    
    -<> the plasma rifle makes a strange whirring sound and then promptly bursts into flame.
    
    {outside_ship > 1:
        
        The creature recoils from the flames and noise. You drop the rifle. It stares at the smoking husk of a gun with an unblinking eye. It then flashes red. Grows in size. Turns and disappears back into the stalks of fungi. Speculation: You’ve offended it. You know, trying to shoot things, even cross-culturally, tends to be quite rude.
    *[You arent' sure why...]
    
    You aren’t sure why, but when the creature looked at you, you felt as if you were being studied, judged. Maybe you’re anthropomorphizing  — but this creature — it seems to be intelligent. It is unclear what this creature wants. If it wants. What it even is. But these things, for now at least, are low on your list of priorities. 

    ** [Actually, what *are* your priorities?] -> after_encounter
    
    }
    

*{outside_ship == 1} [Shoot.]
...
-<> You eat some of your rations. Sort through more ship debris. 
